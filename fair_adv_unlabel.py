...
d_optimizer = torch.optim.Adam(list(model.model_d1.parameters()), lr=0.002)
...
for epoch in range(300):
    ...
    auc_one, auc_res = pc_gender_train.clf_gender_all_pre('auc', epoch, user_e_f,
                                                          64,args.device,user_feature01)
